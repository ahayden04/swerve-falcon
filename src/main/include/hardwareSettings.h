...
class hardwareSettings {
	...
	hardwareSettings() {
        ...
        motorDrive.forwardLimitSwitchNormal = ctre::phoenix::motorcontrol::LimitSwitchNormal_NormallyClosed;
        motorDrive.reverseLimitSwitchNormal = ctre::phoenix::motorcontrol::LimitSwitchNormal_Disabled;
        ...
        motorTurn.diff1Term = ctre::phoenix::motorcontrol::FeedbackDevice::PulseWidthEncodedPosition;
